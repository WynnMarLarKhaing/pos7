...
<a href="<?php echo URLROOT; ?>/sellers" class="btn btn-light"><i class="fa fa-backward"></i> ရှေ့စာမျက်နှာသို့</a>
<div class="card-body bg-light mt-3">
    <form action="<?php echo URLROOT; ?>/sellers/edit/<?php echo $data['id']; ?>" method="post">
