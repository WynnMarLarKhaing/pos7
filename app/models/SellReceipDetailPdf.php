...
class SellReceipDetailPdf
{
    ...
    {
        $this->db->query("INSERT INTO sellReceipt_detail_pdf (receipt_id, stock_id, customer_id, qty, customer_price, total, disp_sort, created_at, updated_at) VALUES (:receipt_id, :stock_id, :customer_id, :qty, :customer_price, :total, :disp_sort, :created_at ,:updated_at)");
        //Bind Values
